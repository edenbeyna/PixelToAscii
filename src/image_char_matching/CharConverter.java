...
public class CharConverter {
    /** Horizontal offset factor for ASCII art characters */
    private static final double X_OFFSET_FACTOR = 0.2;

    /** Vertical offset factor for ASCII art characters */
    private static final double Y_OFFSET_FACTOR = 0.75;

    /** Default font name for rendering ASCII art */
    private static final String FONT_NAME = "Courier New";

    /** Default pixel resolution for rendering ASCII art */
